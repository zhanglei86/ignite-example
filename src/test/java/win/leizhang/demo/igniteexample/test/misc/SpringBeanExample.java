...
package win.leizhang.demo.igniteexample.test.misc;

import org.apache.ignite.Ignite;
import org.springframework.context.support.ClassPathXmlApplicationContext;
import win.leizhang.demo.igniteexample.test.ExampleNodeStartup;
...
public final class SpringBeanExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("spring/spring-bean.xml");
